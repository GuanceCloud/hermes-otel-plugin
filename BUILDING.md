...
`release-vX.Y.Z-notes.md` is the standalone GitHub Release body used by the tag workflow.
...
- Pushing a tag like `v0.1.6` also creates a GitHub Release and attaches:
  ...
  - `output/*.sha256`
  - `output/install.sh`
- The GitHub Release body is published from `artifacts/output/release-vX.Y.Z-notes.md` instead of autogenerated notes.
