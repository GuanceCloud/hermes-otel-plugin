...
- `output/hermes-otel-plugin-v0.1.5.tar.gz`
- `output/hermes-otel-plugin-v0.1.5.tar.gz.sha256`
...
- Pushing a tag like `v0.1.5` also creates a GitHub Release and attaches:
  - `dist/*.whl`
  - `dist/*.tar.gz`
  - `output/*.tar.gz`
  - `output/*.sha256`
